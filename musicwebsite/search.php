...
<div class="row">
    <?php
    if( !empty($search)) {
      $sql ="SELECT * FROM song,singer WHERE song.song_name LIKE '%{$search}%' and song.singer_id=singer.singer_id ";
    ...
    <div class="card" style="background-color: white;margin-top: 20px;margin-left: 35px;overflow: auto;width: 270px; 
          border: 2px solid #F8ABAB;border-radius: 1px;border-bottom: 6px solid #FCA5A5; float: left;">
            ...
            <div style="height:80px">
              ...
              <div><img src="img/<?php echo $row['song_image']?>" style="width: 247px;height: 200px;padding: 7px"></div>
