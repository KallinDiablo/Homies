        ...
        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
          ...
          <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-content">
                      ...
                      <a class="dropdown-item" href="#">Add Singer</a>
                      <div class="dropdown-divider"></div>
                      <a class="dropdown-item" href="songmanger.php">Song Manager</a>
                  </div>
              </li>
        </ul>
    ...
    <div class="testbox">
      ...
      <div class="banner">
          ...
          <div class="item">
            ...
            <label for="fname"> Singer Name<span>*</span></label>
            <input id="fname" type="text" name="singer_name" />
          </div>
          <div class="item">
            <label for="visit">Singer Description<span>*</span></label>
            <input id="visit" type="text" style="height:80px" name="singer_description" />
          </div>
          <div class="item">
            <label for="org">Singer Image<span>*</span></label>
            <input id="org" type="file"   name="singer_image" />
          </div>
        </div>
        <div class="submit">
          <input type="submit" name="add_singer" id="" value="Add Singer">
        </div>
        <?php
        $connect= mysqli_connect('localhost','root','','musicwebsite'); 
          if(isset($_POST['add_singer'])){
            ...
            $singer_image = $_POST['singer_image'];
            $sql = "INSERT INTO singer VALUES('','$singer_name','$singer_description','$singer_image')";
