      ...
      <form action="" method="post">
        ...
        <div class="colums">
          ...
          while ($row_song = mysqli_fetch_array($result)){
            ...
            <input id="fname" type="text" name="song_name" value="<?php echo "$song_name"?>"/>
          </div>
          <div class="item">
            <label for="visit">Song Description<span>*</span></label>
            <input id="visit" type="text" style="height:80px" name="song_description" value="<?php echo "$song_description"?>" />
          </div>
          <div class="item">
            <label for="lname"> Song Price (VNĐ)<span>*</span></label>
            <input id="lname" type="text" name="song_price"  value="<?php echo "$song_price"?>"/>
            <?php
          }
          ?>
          </div>
        ...
        <div class="submit">
          <input type="submit" name="update_product" id="" value="Update">
        </div>
        <?php
          ...
          if(isset($_POST['update_product'])){
            ...
            $sql = "UPDATE song set song_name='$song_name',song_description='$song_description',song_price='$song_price',song_audio='$song_audio',song_img='$song_img',Pop='$Pop',Hip_hop='$Hip_hop',Rock='$Rock',Rhythm='$Rhythm',Funk='$Funk',Jazz='$Jazz',Disco='$Disco',Classical='$Classical',Electronic='$Electronic',Traditional='$Traditional',Independent='$Independent',singer_id='$singer_id' WHERE song_id='$song_id'";
            $result = mysqli_query($connect,$sql);
            if($result){
              ?> <script>
